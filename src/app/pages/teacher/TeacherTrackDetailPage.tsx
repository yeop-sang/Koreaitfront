  ...
  if (!trackName) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <Card className="p-6">
          <p>트랙 정보를 찾을 수 없습니다.</p>
          <Button onClick={() => navigate("/teacher/tracks")} className="mt-4">
            트랙 목록으로 이동
          </Button>
        </Card>
      </div>
          ...
          <div className="flex gap-2">
            {pendingReviews.length > 0 && (
              ...
              >
                ...
                포트폴리오 검토 ({pendingReviews.length})
              </Button>
            )}
            ...
            {isNew && (
              <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-800">
                  ✨ AI가 강의자료를 분석하여 5개의 평가지표를 자동 생성했습니다.
                  필요시 평가지표를 추가하거나 수정할 수 있습니다.
                </p>
              </div>
            )}
